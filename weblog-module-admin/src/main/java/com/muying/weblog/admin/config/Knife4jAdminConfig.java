...
public class Knife4jAdminConfig {
    ...
    public Docket createApiDoc() {
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.muying.weblog.admin.controller"))
    ...
    private ApiInfo buildApiInfo() {
        return new ApiInfoBuilder()
                ...
                .termsOfServiceUrl("https://www.cnblogs.com") // API 服务条款
                .contact(new Contact("刘涛", "https://www.cnblogs.com", "824835580@qq.com")) // 联系人
                .version("1.0") // 版本号
                .build();
    }
}
